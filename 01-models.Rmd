...
Where $y_i$ are the outcomes, $x_i$ the internet adoption values, and $v_i$ indicate the known sampling variances. We specify adaptive multivariate prior distributions on the coefficients
...
We also fit this same model but using the mobile broadband subscriptions as $x$ ("Model 4").
